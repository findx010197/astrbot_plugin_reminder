...
class ScheduleDatabase:
    ...
    def get_schedule_by_short_id(self, short_id: str, sender_id: str = None) -> Optional[ScheduleItem]:
        """
        通过短ID获取日程
    ...
    def find_schedule_by_id_prefix(self, id_prefix: str, sender_id: str) -> Optional[ScheduleItem]:
        """
...
def migrate_from_json(db: ScheduleDatabase, json_file: str, counter_file: str = None) -> int:
    """
